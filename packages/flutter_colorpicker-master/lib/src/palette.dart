...
class _ColorPickerInputState extends State<ColorPickerInput> {
  ...
  Widget build(BuildContext context) {
    if (inputColor != widget.color.value) {
      textEditingController.text = '#${widget.color.red.toRadixString(16).toUpperCase().padLeft(2, '0')}${widget.color.green.toRadixString(16).toUpperCase().padLeft(2, '0')}${widget.color.blue.toRadixString(16).toUpperCase().padLeft(2, '0')}${widget.color.alpha.toRadixString(16).toUpperCase().padLeft(2, '0')}';
    }
    return Padding(
      padding: const EdgeInsets.only(top: 5.0),
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Text('Hex', style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Colors.white)),
